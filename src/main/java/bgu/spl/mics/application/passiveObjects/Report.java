...
public class Report {
	...
	public Report(String MissionName, int mserialNumber, int moneyPennyserialNumber, List<String> AgentsSerialNumbers, List<String> AgentNames, String gadget, int TimeIssued, int TimeCreated, int QTime){
		missionName = MissionName;
		m = mserialNumber;
		moneypenny = moneyPennyserialNumber;
